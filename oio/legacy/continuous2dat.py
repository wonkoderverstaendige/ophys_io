...
def data_dt(num_samples=NUM_SAMPLES):
    return np.dtype([('timestamp', np.int64),            # 8 Byte
                    ...
                    ('samples', (np.int16, num_samples)),  # 2 Byte each x 1024 typ.; note endian type
...
if __name__ == "__main__":
    ...
    parser.add_argument("--chunk_size", default=1e4, help="Number of blocks to read at once as buffer")
